...
@section('content')
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <a href="{{url(route('city.create'))}}" class="btn btn-primary"><i class="fa fa-plus"></i>اضافة مدينة</a>
                 ...
                 @foreach($records as $record)
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="{{url(route('city.edit',$record->id))}}" class="btn btn-success btn-xs"><i class="fa fa-edit fa-lg"></i></a>
                    </td>
                    <td class="text-center">
                      {!! Form::open([
