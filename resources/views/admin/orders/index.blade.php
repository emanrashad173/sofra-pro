...
@section('content')
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        {!! Form::open(['method'=>'GET','action'=>'Admin\OrderController@index','class'=>'navbar-form navbar-left','role'=>'search'])  !!}
               ...
               <tbody>
                 ...
                 @foreach($records as $record)
                  <tr>
                    ...
                    <a href="{{url(route('order.show',$record->id))}}" class="btn btn-success btn-xs"><i class="fa fa-tv"></i></a>
                  </td>
                    <td class="text-center">
                      {!! Form::open([
                        'action' =>['Admin\OrderController@destroy' ,$record->id],
                        'method' => 'delete'
                      ])!!}
