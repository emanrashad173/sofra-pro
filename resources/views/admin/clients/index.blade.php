...
@section('content')
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        {!! Form::open(['method'=>'GET','action'=>'Admin\ClientController@index','class'=>'navbar-form navbar-left','role'=>'search'])  !!}
               ...
               @foreach($records as $record)
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <a href="{{url(route('deactive-client',['id' => $record->id]))}}" class="btn btn-success">نشط</a>
                    @else
                    <a href="{{url(route('active-client',['id' => $record->id]))}}"class="btn btn-danger">غير نشط</a>
                    @endif
                  </td>
